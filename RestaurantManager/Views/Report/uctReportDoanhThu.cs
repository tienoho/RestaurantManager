...
{
    public partial class uctReportDoanhThu : UserControl
    {
        List<HOADONTT_ViewModel> lstHOADONTT;
        List<KHACHHANG> ListKHACHHANG;
        DateTime fromDate;
        DateTime toDate;
        public uctReportDoanhThu()
        {
            InitializeComponent();
        ...
        public static uctReportDoanhThu uctDL = new uctReportDoanhThu();


        private void uctReportDoanhThu_Load(object sender, EventArgs e)
        {
            LoadGrid();
            LoadData();
        }
        ...
        {
            DataRow row = gvDOANHTHU.GetDataRow(gvDOANHTHU.GetSelectedRows()[0]);
        }
        ...
        private void btnPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                var row = gvDOANHTHU.FocusedRowHandle;

                var obj = gvDOANHTHU.GetFocusedRow();
                if (obj == null) return;
        ...
        private void gvHOADONTT_MouseUp(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                var rowH = gvDOANHTHU.FocusedRowHandle;
